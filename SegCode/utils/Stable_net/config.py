...
parser.add_argument ('--n_feature', type=int, default=4, help = 'number of pre-saved features')
parser.add_argument ('--feature_dim', type=int, default=96*96*96, help = 'the dim of each feature')

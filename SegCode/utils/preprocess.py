...
if __name__ == '__main__':
    # path of the original centerline labels
    path = '/home/imed/Research/FocusNet/dataset/Corneal/test/centerline/'
    # path to save the expanded labels
    save_path = '/home/imed/Research/FocusNet/dataset/Corneal/test/mask/'

    if not os.path.exists(save_path):
        os.makedirs(save_path)

    expand_label(path, save_path)
